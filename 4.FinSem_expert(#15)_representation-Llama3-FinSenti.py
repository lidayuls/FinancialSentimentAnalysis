...
my_dataset_FPB = load_dataset('/kaggle/input/finhmoe-datasets/financial_phrasebank-sentences_50agree_processed')
my_dataset_FiQA = load_dataset('/kaggle/input/finhmoe-datasets/fiqa-2018_processed')
my_dataset_TFNS = load_dataset('/kaggle/input/finhmoe-datasets/news_with_gpt_instructions_processed')
my_dataset_NWGI = load_dataset('/kaggle/input/finhmoe-datasets/twitter-financial-news-sentiment_processed')
