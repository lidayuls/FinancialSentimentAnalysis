...
Description:
This script implements the **Financial Numeric Reasoning Expert (FinNum) (Qwen-Math,Qwen-Coder,CodeLlama,CodeGemma) ** 
...
model_name = "Qwen2.5-Math-7B-Instruct-bnb-4bit"  # Base model identifier
max_seq_length = 256
dtype = None
load_in_4bit = True
